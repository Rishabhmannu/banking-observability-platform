...
sleep 20
docker compose -f docker-compose.messaging.yml up -d rabbitmq kafka kafka-exporter message-producer message-consumer
...
echo ""
echo "✨ System ready with messaging and database monitoring!"